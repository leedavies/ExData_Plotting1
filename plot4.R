...
## Creates a png file called plot4.png that contains
## a plot of the Global_active_power variable for 1st Feb 2007 and 2nd Feb 2007 
## a plot of the voltage variable for 1st Feb 2007 and 2nd Feb 2007
## a plot of the 3 sub metering variable for 1st Feb 2007 and 2nd Feb 2007
## a plot of the Global_reactive_power variable for 1st Feb 2007 and 2nd Feb 2007
...
# set the layout for the four plots
par(mfrow = c(2,2))
